...
<script src="https://www.google.com/recaptch/api.js"></script>
            ...
            <div class="card card-body bg-light">
                ...
                <form name="joinfrm" id="joinfrm">
                    <div class="row">
                        <div class="col-11 offset-1">
                            ...
                            <div class="form-group row">
                                ...
                                <span class="col-form-label">&nbsp;8~16자의 영문 소문자, 숫자와 특수기호(_)만 사용할수 있습니다</span>
                            </div> <!--아이디-->
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <input type="text" name="zip1" id="zip1"
                                        class="form-control border-danger col-1">
                                 <span class="col-form-label" readonly>&nbsp; &mdash; &nbsp;</span>
                    ...
                    <div class="row">
                        ...
                        <hr>
                            <button type="button" class="btn btn-primary" id="joinbtn"><i class="fas fa-check-circle"></i> 입력완료</button>
                            <button type="button" class="btn btn-danger" id="cancelbtn"><i class="fas fa-times-circle"></i> 입력취소</button>
                            ...
                            <form name="zipfrm" id="zipfrm">
                                ...
                                <input type="text" name="dong" id="dong"
                                    ...
                                    <button type="button" class="btn btn-primary"
                                            id="findzipbtn"><i class="fas fa-search"></i> 검색하기</button>
                                </div>
                                <div class="form-group row">
                                <hr class="col-9">
                                <p class="col-12 text-danger text-center">지역의 읍/면/동의 이름을 공백없이 입력하신 후, [검색하기] 버튼을 클릭하세요</p>
                                <select class="col-8 offset-2 form-control" size="10"
                                        id="addrlist" name="addrlist">
