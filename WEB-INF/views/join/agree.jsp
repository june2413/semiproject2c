...
회원가입을 위해서 아래 사이트 이용약관 개인정보 수집 및 이용에 대한 안내를 읽고 동의해 주세요
            </small>
                <hr>
            </div> <!--섹션타이틀-->
            ...
            <div class="card card-body bg-light">
                ...
                <form name="agreefrm" id="agreefrm">
                    <div class="form-group"><textarea rows="10" class="form-control border-danger">
                    카카오계정 약관
...
Copyright © Kakao Corp. All rights reserved.
            ...
            <div class="bg-light text-center">
                <button type="button" id="okagree" class="btn btn-success">모두 동의합니다</button>
                 <button type="button" id="noagree" class="btn btn-danger">모두 동의하지않습니다</button>
            </div> <!-- 버튼들 -->
